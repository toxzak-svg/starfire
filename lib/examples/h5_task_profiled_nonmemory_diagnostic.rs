...
/// Reproduce the canonical fixed-width, task-profiled real-component stream
/// without exposing task labels to downstream diagnostics.
///
/// This is a read-only fixture boundary. It does not run H5 gates, fit an
/// ontology, or modify the frozen H5 constants.
pub fn canonical_task_profiled_fixed_windows(
