...
1. **Popcode Router** — replaces softmax with a learned VQ codebook. The router
...
2. **Ring Attractor** — a 2D continuous attractor maintains routing state across
...
3. **Adversarial Diversity Regularizer** — penalizes code collapse (usage imbalance
...
print('SR-MoE components loaded OK')
"""
cells.append(code(sr_moe.split('\n')))
...
"""
cells.append(code(arch_b.split('\n')))
...
"""
cells.append(code(ep_gen.split('\n')))
...
"""
cells.append(code(trainer_cls.split('\n')))
...
out_path = 'C:/dev/SRMoE_Training.ipynb'
...
import os
print(f'Size: {os.path.getsize(out_path)/1e3:.0f} KB')
