...
class SearchPanel {
    ...
    static createOrShow(uri, store) {
        if (SearchPanel.currentPanel) {
            SearchPanel.currentPanel.panel.reveal(vscode.ViewColumn.One, true);
            return;
        }
        const panel = vscode.window.createWebviewPanel(SearchPanel.viewType, 'Component Crate', { viewColumn: vscode.ViewColumn.One, preserveFocus: false }, { enableScripts: true, retainContextWhenHidden: true });
...
SearchPanel.viewType = 'component-crate.search';
