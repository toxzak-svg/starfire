...
cells.append(m(
    "# SR-MoE Training\n\n"
    "**Sparse Routing Mixture-of-Experts** with:\n"
    "1. Popcode VQ codebook router (discrete codeword selection, not softmax)\n"
    "2. Ring attractor for path-dependent routing state (grid-cell-like)\n"
    "3. Adversarial diversity regularizer (prevents code collapse)\n\n"
    "Run all cells. GPU strongly recommended.\n\n"
    "## Runtime settings (last cell)\n"
...
# ── Cell 2: SR-MoE Components ──────────────────────────────────────────────────
cells.append(c(
    "# === SR-MoE Core Components ===",
    "",
